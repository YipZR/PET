...
df = pd.read_table("landfill_Abundance_OTU_result.txt")
#print(df1)
...
Kingdom.to_csv("OTU_Abundance_Kingdom.txt",sep="\t",index=False)
...
Phylum.to_csv("OTU_Abundance_Phylum.txt",sep="\t",index=False)
...
Order.to_csv("OTU_Abundance_Order.txt",sep="\t",index=False)
...
Family.to_csv("OTU_Abundance_Family.txt",sep="\t",index=False)
...
Genus.to_csv("OTU_Abundance_Genus.txt",sep="\t",index=False)
...
Species.to_csv("OTU_Abundance_Species.txt",sep="\t",index=False)
